  ...
  Widget _buildUserListView(List<SystemAccountModel> userList, {required bool isVendor, required bool isDark}) {
    if (userList.isEmpty) {
      return EmptyStateView(
        icon: isVendor ? Icons.store_rounded : Icons.person_off_rounded,
        title: 'No ${isVendor ? "Vendors" : "Students"} Found',
        message: 'No registered accounts matching query "$_searchQuery".',
      );
    }
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  CircleAvatar(
                    backgroundColor: isVendor ? const Color(0xFF4A6CF7) : const Color(0xFF4CD964),
                    child: Icon(
                      isVendor ? Icons.store_rounded : Icons.person_rounded,
                      color: Colors.white,
                      size: 20,
                    ),
                  ),
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text('Copy ID', style: TextStyle(fontFamily: 'Inter', fontSize: 11, color: isDark ? Colors.white70 : Colors.black54)),
                                  ],
                                ),
                              ),
                            ),
              ...
              Row(
                ...
                children: [
                  OutlinedButton.icon(
                    ...
                    icon: Icon(item.isBlocked ? Icons.check_circle_outline_rounded : Icons.block_rounded, size: 16),
                    label: Text(item.isBlocked ? 'Unblock User' : 'Block User', style: const TextStyle(fontSize: 12)),
                  ),
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text('Delete ID', style: TextStyle(fontSize: 12)),
                  ),
                ],
              ),
            ],
